...
export const themeVariables: IncomingThemeVariables = {
  ...
  light: {
    bellButton:
      'w-10 h-10 shadow-xl shadow-neutral-300 border border-neutral-300 hover:shadow-neutral-400',
    popup: 'rounded-3xl shadow-xl shadow-neutral-300 border border-neutral-300',
  },
};
    ...
    <div className="flex flex-col h-screen bg-white dark:bg-black">
      ...
      <div className="h-full text-2xl flex flex-col justify-center">
        ...
        <code className="text-center text-neutral-400 dark:text-neutral-600">
          examples/
          <code className="text-neutral-900 dark:text-neutral-100">chat</code>
        </code>
      </div>
    </div>
  );
